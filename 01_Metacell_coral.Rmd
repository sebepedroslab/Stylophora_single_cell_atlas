...
# png
#tgconfig::override_params(file.path(scdb_dir,"spis_metacell_params.yaml"),"metacell")
...
knitr::include_graphics("clustering_coral/scdb/figs/mc_coral.2dproj.2d_graph_proj.png")
```
...
top_genes <- fread("annotation/marker_genes.txt",header=FALSE)[[1]]
marker_genes <- fread("annotation/marker_genes.txt",header=FALSE)[[1]]
heatmap_genes <- intersect(top_genes,marker_genes)
...
#   black_list = c(bl,grep("orphan",rownames(mc@mc_fp),value=TRUE)), 
#   highlight_genes = top_genes,
#   output_file=file.path(scdb_fig_dir,sprintf("Spis_coral_gene_expression_minimal")),
#   plot_format = "png", width = 2600, height = 3200, res = 100, plot_sc_width_cex = 1,
#   #plot_format = "pdf", width = 60, height = 150, plot_sc_width_cex = 1.2,
#   show_gene_names = TRUE, gene_font_size = 10, gene_chr_limit = 40, 
#   show_mc_names = FALSE, mc_font_size = 0, mc_label_cex = 1.5, 
#   clust_bars = ssmc, #clust_anno_size = unit(5,"mm"),
#   gene_annot_file = file.path(annot_dir,"Spis_annotation_v7_2020-10-26_clean"), 
#   tfs_annot_file = file.path(annot_dir,"curated_TFh_Spis_EDITED_NAMES.csv"), 
...
knitr::include_graphics("clustering_coral/scdb/figs/Spis_coral_gene_expression_minimal.png")
```
