...
hms <- scp_plot_cmod_markers(
  ...
  plot_format = "pdf", width = 50, height = 70, plot_sc_width_cex = 1,
  show_gene_names = TRUE, gene_font_size = 20, gene_chr_limit = 30,
  show_mc_names = TRUE, mc_font_size = 12, mc_label_cex = 0.6, clust_bars = ssmc,
