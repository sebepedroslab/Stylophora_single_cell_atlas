...
saveRDS(mc@mc_fp, file=file.path(scdb_dir, "Spis_larva_metacell_gene_FC.RDS"))
...
saveRDS(mc_umis, file=file.path(scdb_dir, "Spis_larva_metacell_UMI_counts.RDS"))
...
saveRDS(mc_umifrac, file=file.path(scdb_dir, "Spis_larva_metacell_UMI_fractions.RDS"))

# cell assignments to metacells
cell_mc <- structure(mc@mc, names=names(mc@mc))
saveRDS(cell_mc, file=file.path(scdb_dir, sprintf("Spis_larva_metacell_assignments.RDS",mc_id)))

# 2d data
mc2d_id <- sprintf("%s.2dproj",mc_id)
mc2d <- scdb_mc2d(id=mc2d_id)
saveRDS(mc2d, file=file.path(scdb_dir, "Spis_larva_mc2d.RDS"))
...
hms <- scp_plot_cmod_markers(
  ...
  plot_format = "pdf", width = 45, height = 40, plot_sc_width_cex = 1,
