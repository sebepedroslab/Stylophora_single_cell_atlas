...
```{r}
# feature_in_thrs=1.2; feature_out_thrs=1.8; abs_leakyness=0.1; abs_leakynessbg=0.1 # violin
# feature_in_thrs=1.5; feature_out_thrs=100; abs_leakyness=0; abs_leakynessbg=0 # violin2
# feature_in_thrs=1.2; feature_out_thrs=100; abs_leakyness=0; abs_leakynessbg=0 # violin3
...
# single plot
pdf(
  file.path(plotdir,sprintf("pairwise.ct.expression.fc%s.fcout%s.violin.pdf",feature_in_thrs,feature_out_thrs)),
