...
fwrite(cell_df, file=file.path(scdb_dir, "Spis_polyp_metacell_assignments"), sep="\t")
...
# png
tgconfig::override_params(file.path(scdb_dir,"spis_polyp_metacell_params.yaml"),"metacell")
mcell_mc2d_plot_mas(
  mc2d_id=sprintf("%s.2dproj",mc_id),
...
knitr::include_graphics("clustering_polyp/scdb/figs/mc_polyp.2dproj.2d_graph_proj.png")
```
...
hms <- scp_plot_cmod_markers(
  ...
  plot_format = "pdf", width = 40, height = 40, plot_sc_width_cex = 1,
...
#   black_list = c(bl,grep("orphan",rownames(mc@mc_fp),value=TRUE)), 
#   highlight_genes = top_genes,
#   output_file=file.path(scdb_fig_dir,sprintf("Spis_polyp_gene_expression_minimal")),
...
knitr::include_graphics("clustering_polyp/scdb/figs/Spis_polyp_gene_expression_minimal.png")
```
